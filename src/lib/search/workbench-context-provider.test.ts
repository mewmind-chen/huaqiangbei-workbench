...
test("quotation context normalizes MPN and aggregates only the safe fields", () => {
  const context = buildQuotationContext("  stm32Ｆ103c8t6  ", [
    { mpn: "STM32F103C8T6", status: "待报价", updatedAt: "2026-08-23T08:00:00.000Z" },
    { mpn: " stm32f103c8t6 ", status: "已完成", updatedAt: "2026-08-24T08:00:00.000Z" },
    { mpn: "STM32F103C8T6", status: "跟进中", updatedAt: "2026-04-01T08:00:00.000Z" },
    { mpn: "OTHER", status: "待报价", updatedAt: "2026-08-24T08:00:00.000Z" },
...
test("quotation context returns zeroes without exposing quote details", () => {
  const context = buildQuotationContext("W25Q64JV", [
    { mpn: "W25Q64JV", status: "已完成", updatedAt: "2026-08-24T08:00:00.000Z" },
  ], new Date("2026-08-24T12:00:00.000Z"));
